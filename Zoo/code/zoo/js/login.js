...
function loginHandle() {
  var username = document.forms["login-form"].elements["username"].value;  //thẻ form có name= login-form  và thẻ input có name= username
...
/*
"Mua Thành Công. + "<br>" + Qúy Khách Sẽ Nhận Được Vé Sau 2 Ngày Nữa.";
var LOGIN_API="https://youtube-api-challenger2.appspot.com/authentication";
var btnSubmit = document.getElementById("btnSubmit");
if(btnSubmit != null){
  btnSubmit.onclick = function () {
...
//mở kết nối tới server với địa chỉ cho trước. phương thúc POST.
xhr.open("POST", LOGIN-API, true); //gửi lên dầu , kiểu gửi là gì.
